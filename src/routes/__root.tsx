...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Snarr - Multi-source daily updates in one app" },
      ...
      { name: "apple-mobile-web-app-title", content: "Snarr" },
      { property: "og:title", content: "Snarr - Multi-source daily updates in one app" },
      ...
      { name: "twitter:title", content: "Snarr - Multi-source daily updates in one app" },
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", href: "/snarr-icon.png" },
      { rel: "apple-touch-icon", href: "/snarr-icon.png" },
      { rel: "shortcut icon", type: "image/png", href: "/snarr-icon.png" },
    ],
  }),
